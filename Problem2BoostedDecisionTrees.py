...
def try_xgboost_combination(X_train, y_train, X_test, y_test, n_estimators=100, max_depth=None, reg_lambda=1e-5, learning_rate=1.0):
    bdt = XGBClassifier(n_estimators=n_estimators, max_depth=max_depth, reg_lambda=reg_lambda, learning_rate=learning_rate, missing=np.nan)
...
# bdt_out = determine_xgboost_hp(X_train, y_train, X_test, y_test, 100, None, 1, 1.0, 0, None)
# print(bdt_out[0])
# print(bdt_out[1])
# print(bdt_out[2])
# print(bdt_out[3])
